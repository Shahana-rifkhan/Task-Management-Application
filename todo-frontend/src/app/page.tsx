  ...
  return (
    <main className="flex h-screen w-screen items-center justify-center bg-gradient-to-b from-white to-purple-500">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        <h2 className="text-2xl font-bold mb-6 text-center dark:text-black">Welcome to <span className='text-purple-500'>Code94 Labs - Task Management Application!</span></h2>
